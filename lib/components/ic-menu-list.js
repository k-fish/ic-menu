...
export default Ember.Component.extend({
  ...
  focusTrigger: function() {
    this.get('parentMenu.listTrigger').focus();
  },
  ...
  focusFirstItemOnOpen: function() {
    ...
    Ember.run.next(this, function() {
      if (this.get('parentMenu.listTrigger.lastClickEventWasMouse')) {
  ...
  registerWithParent: function() {
    this.get('parentMenu').registerList(this);
  }.on('didInsertElement'),
