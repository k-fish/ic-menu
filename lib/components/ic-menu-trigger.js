...
export default Ember.Component.extend({
  ...
  ariaOwns: function() {
    return this.get('parentMenu.list.elementId');
  }.property('parentMenu.list'),

  mouseDown: function() {
    if (!this.get('parentMenu.list.isOpen')) return;
  ...
  openList: function(event) {
    ...
    this.get('parentMenu').openList();
  },

  registerWithParent: function() {
    this.get('parentMenu').registerTrigger(this);
  }.on('didInsertElement'),
